...
(function(e,t)
{
		...
		if(st.acceptData(e))
		{
			...
			if(f&&c[f]&&(i||c[f].data)||!u||r!==t)
				return 	f||(l?e[s]=f=K.pop()||st.guid++:f=s),
						...
						u?(a=o[n],
						null==a&&(a=o[st.camelCase(n)])):a=o,a
		}
	}
	...
	function o(e,t,n)
	{
		if(st.acceptData(e))
		{
			...
			if(u[l])
			{
				...
				(n||(delete u[l].data,s(u[l])))&&(a?st.cleanData([e],!0):st.support.deleteExpando||u!=u.window?delete u[l]:			
				u[l]=null)
			}
		}
	}
	...
	function f(e,t,n)
	{
		...
		return st.grep(e,	function(e,r){var i=!!t.call(e,r,e);return i===n});
		if(t.nodeType)
			...
			"script"===n&&t.text!==e.text?(h(t).text=e.text,g(t)):"object"===n?(t.parentNode&&(t.outerHTML=e.outerHTML),
					st.support.html5Clone&&e.innerHTML&&!st.trim(t.innerHTML)&&(t.innerHTML=e.innerHTML)):
						"input"===n&&Zt.test(e.type)?(t.defaultChecked=t.checked=e.checked,t.value!==e.value&&(t.value=e.value)):
							"option"===n?t.defaultSelected=t.selected=e.defaultSelected:("input"===n||"textarea"===n)&&(t.defaultValue=e.defaultValue)
		}
	}
	...
	function N(e,t)
	{
		for(var n,r=[],i=0,o=e.length;o>i;i++)
			...
			(
				...
				t?
				(
					r[i]||"none"!==n.style.display||(n.style.display=""),""===n.style.display&&w(n)&&
					(
